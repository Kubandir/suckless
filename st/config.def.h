 ...
 */
static char *font = "FiraCode Nerd Font:style=Regular:pixelsize=12";
...
/* Tokyo Night colors (first 16 used by escape sequences) */
static const char *colorname[] = {
	...
	"#7da6ff", /* bright blue */
	"#d0a9ff", /* bright magenta */
	"#2ac3de", /* bright cyan */
	"#c0caf5", /* bright white */

	/* more colors can be added after 255 to use with DefaultXX */
	[256] = "#c0caf5", // foreground
	[257] = "#1a1b26", // background (darker version)
	[258] = "#7aa2f7", // cursor
